						...
						<div class="panel panel-default  ">
							<div class="panel-heading "
								...
								<i class="fa-ticket fa" style="font-size: 40px;">&emsp;&emsp;
									 <%=new FeedbackDAO().FeedbackCounter()%> 
								</i>
							</div>
							<div class="panel-body gujju-theme-d2" style="font-weight: bold;">Feedback</div>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="panel panel-default   gujju-card-16 ">
							<div class="panel-heading  "
								style="color: white; background-color: #367FA9;">
								<i class="fa-ticket fa" style="font-size: 40px;">&emsp;&emsp;
									  <%=new FeedbackDAO().ScheduleCounter()%> 
								</i>
							</div>
							<div class="panel-body gujju-theme-d2" style="font-weight: bold;">Schedule</div>
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="panel panel-default   gujju-card-16 ">
							<div class="panel-heading  "
								style="color: white; background-color: #367FA9;">
								<i class="fa-ticket fa" style="font-size: 40px;">&emsp;&emsp;
									  <%=new FeedbackDAO().LogCounter()%> 
								</i>
							</div>
							<div class="panel-body gujju-theme-d2" style="font-weight: bold;">Log</div>
						</div>
					</div>
					<div class="col-sm-1"></div>
				</div>
						...
						<div class="panel panel-default     gujju-card-16 ">
							<div class="panel-heading "
								...
								<i class="fa fa-ticket" style="font-size: 40px;">&emsp;&emsp;
									 <%=new FeedbackDAO().todayScheduleCounter()%>
								</i>
							</div>
						...
						<div class="panel panel-default     gujju-card-16 ">
							<div class="panel-heading "
								...
								<i class="fa fa-newspaper-o" style="font-size: 40px;">&emsp;&emsp;
									 <%=new FeedbackDAO().todayLogCounter()%> 
								</i>
							</div>
							<div class="panel-body gujju-theme-d2" style="font-weight: bold;">Log</div>
						</div>
