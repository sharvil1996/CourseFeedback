...
<title>Admin | Course Wise Question Avg Tabular</title>
<noscript>
...
<body>
	...
	<div style="margin-top: -850px; margin-left: 250px;">
		...
		<h1>
			Course Wise Tabular<small> Question Average</small>
		</h1>
		<ol class="breadcrumb">
		...
		<div class="col-lg-6">
			<div class="container">
				<form action="CourseQuestionAvgTabularServlet" method="post"
					name="Registration">
					<br /><br /><br />
					<div class="row">
